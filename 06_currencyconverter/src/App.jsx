...
function App() {
  ...
  return (
    ...
    justify-center items-center bg-cover bg-no-repeat"
      style={{
        backgroundImage:
          "url(https://media.istockphoto.com/id/157308559/photo/money-pile-100-dollar-bills.jpg?b=1&s=612x612&w=0&k=20&c=ylI_dQNflTWGrd6LojfBVoHw05y_dvOcY7i0UKOc9Ro=)",
      }}
    >
      <div className="w-full">
        <div
          className="w-full max-w-screen-md mx-auto border
